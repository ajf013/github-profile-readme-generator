  ...
  const fetchData = async () => {
    if (shouldRequestStats()) {
      var response = await axios.get(
        "https://api.github.com/repos/ajf013/github-profile-readme-generator"
      )
    ...
    <div className="shadow flex items-center justify-center flex-col mb-2 py-2">
      ...
      <div className="flex justify-center items-center">
        <a
          ...
          aria-label="Star ajf013/github-profile-readme-generator on GitHub"
          target="blank"
          className="mr-2"
        >
        ...
        <a
          href="https://github.com/ajf013/github-profile-readme-generator/fork"
          aria-label="Fork ajf013/github-profile-readme-generator on GitHub"
          target="blank"
        >
          <div className="text-xxs sm:text-sm border-2 border-solid border-gray-900 bg-gray-100 flex items-center justify-center py-1 px-2">
            <RepoForkedIcon
